/**
 * Base/Secure 옵션 계층과 진입점별 공개 타입을 검증합니다.
 *
...
type _RootOptions = Expect<Equal<RootDduOptions, DduOptions>>;
type _RootConstructorOptions = Expect<Equal<RootDduConstructorOptions, DduConstructorOptions>>;
type _BrowserOptions = Expect<Equal<BrowserDduOptions, DduOptions>>;
