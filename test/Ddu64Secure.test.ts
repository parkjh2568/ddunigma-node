/**
 * Unit tests for Ddu64Secure - Node.js-specific wrapper.
 */
...
describe("Ddu64Secure", () => {
  ...
  describe("All Ddu64 features work through Ddu64Secure", () => {
    ...
    it("chunking round-trip", () => {
      const encoder = new Ddu64Secure(undefined, undefined, { chunkSize: 20 });
