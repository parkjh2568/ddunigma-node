...
} from "../src/obfuscation/ObfuscationLayer.js";
import {
  HANGUL_SYLLABLE_START,
  HANGUL_SYLLABLE_END,
  HANGUL_SYLLABLE_COUNT,
  buildSyllableMap,
} from "../src/obfuscation/syllableMap.js";

/** charset + padding 알파벳으로 난독화 레이어를 만듭니다. */
...
import { buildCodaCharset } from "../src/core/codecUtils.js";
...
describe("ObfuscationLayer", () => {
  ...
  describe("HangulObfuscationLayer - DDU charset", () => {
    ...
    it("should preserve output length", () => {
  ...
  describe("createObfuscationLayer", () => {
    it("인코더 footer 문자까지 포함한 문자열을 라운드트립한다", () => {
      const layer = createEncoderObfuscationLayer(["A", "B", "C", "D"], "X");
      const input = "ABCDENC123V4";
